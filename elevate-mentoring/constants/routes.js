module.exports = {
	routes: [
		...
		{
			sourceRoute: '/user/v1/organization/addRegistrationCode/:id',
			type: 'PATCH',
			inSequence: false,
			service: 'user',
			orchestrated: false,
			targetRoute: {
				path: '/user/v1/organization/addRegistrationCode/:id',
				type: 'PATCH',
			},
		},
		{
			sourceRoute: '/user/v1/organization/addRegistrationCode',
			type: 'PATCH',
			inSequence: false,
			service: 'user',
			orchestrated: false,
			targetRoute: {
				path: '/user/v1/organization/addRegistrationCode',
				type: 'PATCH',
			},
		},
		{
			sourceRoute: '/user/v1/organization/removeRegistrationCode/:id',
			type: 'PATCH',
			inSequence: false,
			service: 'user',
			orchestrated: false,
			targetRoute: {
				path: '/user/v1/organization/removeRegistrationCode/:id',
				type: 'PATCH',
			},
		},
		{
			sourceRoute: '/user/v1/organization/removeRegistrationCode',
			type: 'PATCH',
			inSequence: false,
			service: 'user',
			orchestrated: false,
			targetRoute: {
				path: '/user/v1/organization/removeRegistrationCode',
				type: 'PATCH',
			},
		},
		{
